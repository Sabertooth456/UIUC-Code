...
class List {
  ...
  public:
    ...
    void print(std::string message, ListNode * head) const;

    bool complete(ListNode * head) const;
    ...
    // ListIterator is an inner-class of List, defined in a separate
    // file:
  ...
  private:
    ...
    // void reverse(ListNode*& startPoint, ListNode*& endPoint, int n);

    /**
     * Helper function that reverses the "next" and "prev" values of the
     * passed node
     * 
     * @param node A pointer to the node whose directions will
     * be reversed
     */
    void reverseDirection(ListNode * node);

    /**
     * Inserts the node after the insertion point and returns the nodes after it
     * @param insertPoint The pointer reference to the node after which data will be inserted
     * @param node A pointer reference to the node be inserted
     * @return The ListNodes after the given node
     */
    ListNode* insertNode(ListNode * insertPoint, ListNode * node);
