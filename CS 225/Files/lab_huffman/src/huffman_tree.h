...
class HuffmanTree
{
  public:
    ...
    /**
     * Test function for removeSmallest, function is meant to
     * called for testing purposes to make sure that removeSmallest
     * is working correctly
     *
     * @param single The first vector to inspect.
     * @param merge The second vector to inspect.
     * @return The smallest frequency from both vectors.
     */
    static Frequency testRemoveSmallest(std::vector<Frequency> single,
  ...
  private:
     ...
     * Helper method
    */
    void readTree(TreeNode* cur_node, BinaryFileReader& bfile);
     ...
     */
    static TreeNode* removeSmallest(std::queue<TreeNode*>& singleQueue,
