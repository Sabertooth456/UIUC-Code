...
class AVLTree
{
  ...
  private:
    /**
     * Helper for rotations that recalculate the height of the nodes
     * Assumes that the left and right children of t are not nullptr
     * @param t Node to be rebalanced
    */
    void recalculateHeight(Node* t);
