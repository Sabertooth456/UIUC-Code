...
public:
    ...
    */
     ...
     * 
     * That is, when you setunion two disjoint sets, the smaller (in terms of number of
     * nodes) should point at the larger. This function works as described in lecture, 
     * except that you should not assume that the arguments to setunion are roots of 
     * existing uptrees.
     * 
     * Your setunion function SHOULD find the roots of its arguments before combining the
     * trees. If the two sets are the same size, make the tree containing the second
