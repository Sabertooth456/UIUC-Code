...
class Student {
 ...
 private:
  ...
  std::string net_id_;
  std::string major_;
  bool graduated_;  // Whether or not the student has graduated
  std::vector<Course> courses_;
  static const int min_credits_grad_ =
      120;  // The minimum credits a student needs to graduate. Value is 120
};
