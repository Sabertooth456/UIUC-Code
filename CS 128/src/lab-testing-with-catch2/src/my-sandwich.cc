...
string Sandwich::toppings[5] = {"cheese", "lettuce", "tomato", "onions",
                                "pickles"};
...
const vector<string>& Sandwich::GetToppings() const { return toppings_; }

const vector<string>& Sandwich::GetDressings() const { return dressings_; }
