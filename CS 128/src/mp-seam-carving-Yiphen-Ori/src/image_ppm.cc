...
ImagePPM::ImagePPM(int width, int height, int max_color_value)
    : height_(height), width_(width), max_color_value_(max_color_value) {
...
void ImagePPM::SetPixel(int row, int col, Pixel pixel) {
